            ...
            >
              <div className="bg-lightBlack  p-[30px] lg:p-[45px] 2xl:p-[61px]">
                ...
                <div className="grid items-center grid-cols-1 gap-2 mt-8">
                  <input
                    type="text"
                    className="w-full h-12 md:h-13 lg:h-[59px] px-4 border border-[#404040] dark:border-lightGray text-gray dark:text-lightGray outline-none  bg-transparent mt-4 focus:ring-0 placeholder:text-[#606060] focus:border-gray dark:focus:border-lightGray focus:outline-none"
                  ...
                  <textarea
                    ...
                    cols="30"
                    rows="10"
                    className="w-full h-[121px] px-4 border border-[#404040] dark:border-lightGray text-gray dark:text-lightGray outline-none  bg-transparent mt-4 focus:ring-0 placeholder:text-[#606060] resize-none focus:border-gray dark:focus:border-lightGray focus:outline-none"
