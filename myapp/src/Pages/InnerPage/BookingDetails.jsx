...
<div>
  ...
  <div className="flex gap-2 flex-wrap">
    <select className="flex-1 min-w-[150px] border border-gray-300 rounded-md px-3 py-2 focus:ring-1 focus:ring-green-500 focus:outline-none">
      {countries.map((country) => (
        <option key={country}>{country}</option>
              ...
              <div>
                <label className="block text-gray-700 font-medium">Country/Region</label>
                <select className="w-full border border-gray-300 rounded-md px-3 py-2 mt-1 focus:ring-1 focus:ring-green-500 focus:outline-none placeholder:text-[#808080]">
...
<div>
  ...
  <div className="flex gap-2 flex-wrap">
    <select className="flex-[1_1_30%] min-w-[80px] border border-gray-300 rounded-md px-2 py-2 focus:ring-1 focus:ring-green-500 focus:outline-none">
      {phoneCodes.map((code) => (
