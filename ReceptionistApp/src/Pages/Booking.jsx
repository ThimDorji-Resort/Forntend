...
const Booking = () => {
  ...
  // Enrich data for non-AVAILABLE tabs
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex flex-col relative">
        ...
        <main className="flex-1 overflow-y-auto bg-gray-50 p-2 relative">
          {/* Tabs + Search */}
            ...
            <table className="min-w-full divide-y divide-[#9CA3AF]">
              ...
              <tbody className="bg-white divide-y divide-[#9CA3AF]">
                ...
                {filteredData.length === 0 && (
                  <tr>
                    <td
                      colSpan={activeTab !== "AVAILABLE" ? 5 : 4}
